...
execute_process(
  COMMAND "/usr/bin/git" show-ref "213d13e584a8cb3bf0e7caf5d1d40cd10f4254ae"
  WORKING_DIRECTORY "/home/joseph/TTG/ttg/build/_deps/lapackpp-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "213d13e584a8cb3bf0e7caf5d1d40cd10f4254ae")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("213d13e584a8cb3bf0e7caf5d1d40cd10f4254ae" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/213d13e584a8cb3bf0e7caf5d1d40cd10f4254ae")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/joseph/TTG/ttg/build/_deps/lapackpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/joseph/TTG/ttg/build/_deps/lapackpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
