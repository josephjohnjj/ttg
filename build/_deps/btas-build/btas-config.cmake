...
if(${Boost_BTAS_DEPS_LIBRARIES_NOT_FOUND_CHECK})
  ...
  if (Boost_USE_CONFIG)
    set(Boost_CONFIG /usr/local/lib/cmake/Boost-1.70.0/BoostConfig.cmake)
...
if(NOT TARGET blaspp)
  ...
  get_filename_component(blaspp_DIR "/usr/local/lib/blaspp/blasppConfig.cmake" DIRECTORY)
  find_dependency( blaspp CONFIG REQUIRED HINTS "${blaspp_DIR}" )
endif()
if(NOT TARGET lapackpp)
  include( CMakeFindDependencyMacro )
  get_filename_component(lapackpp_DIR "/usr/local/lib/lapackpp/lapackppConfig.cmake" DIRECTORY)
